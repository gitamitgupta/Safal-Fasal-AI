  ...
  return (
    <section className="w-full bg-green-50 rounded-lg p-8 my-6 flex flex-col md:flex-row items-center max-h-[400px]">
      ...
      <div className="md:w-1/2 w-full pr-6">
        <h2 className="text-4xl font-extrabold text-purple-800 mb-4">Welcome Kishore Ji!</h2>
        ...
        <button className="bg-purple-700 text-white px-6 py-3 rounded hover:bg-green-600 transition">
          Explore
        </button>
      </div>
